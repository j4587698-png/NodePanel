...
public sealed record RuntimeTlsClientHelloMetadata
{
...
internal static class RuntimeTlsClientHelloReader
{
...
public static class RuntimeTlsClientHelloParser
{
    public static bool TryParse(ReadOnlySpan<byte> payload, out RuntimeTlsClientHelloMetadata metadata)
    {
        metadata = new RuntimeTlsClientHelloMetadata();
