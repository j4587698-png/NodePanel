...
internal sealed record Shadowsocks2022InboundSessionOptions : IRuntimeInboundConnectionOptions
{
    internal Shadowsocks2022InboundRuntimeState? RuntimeState { get; init; }
    ...
    internal Shadowsocks2022InboundSessionOptions WithUserLevel(int userLevel)
    {
